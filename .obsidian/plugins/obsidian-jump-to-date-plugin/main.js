...
var CalendarPicker = class {
  ...
  initializePicker() {
    ...
    if (this.picker !== null)
      this.picker.destroy();
    const querySelectorPathForParent = import_obsidian3.Platform.isMobileApp || import_obsidian3.Platform.isMobile ? ".mobile-navbar-action" : 'div[aria-label="Jump-to-Date"]';
    this.picker = esm_default(
...
var ThePlugin = class extends import_obsidian6.Plugin {
  ...
  showRibbonButton() {
    this.ribbonIcon = this.addRibbonIcon("JumpToDate", "Jump-to-Date", () => __async(this, null, function* () {
      if (import_obsidian6.Platform.isMobileApp || import_obsidian6.Platform.isMobile) {
        this.datePicker.open();
      }
      return;
    }));
