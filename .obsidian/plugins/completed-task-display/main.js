...
var TaskHiderPlugin = /** @class */ (function (_super) {
    ...
    function TaskHiderPlugin(app, manifest) {
        ...
        _this.hiddenState = true; // Default state
        _this.statusBar = _this.addStatusBarItem();
        return _this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.saveHiddenState()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    TaskHiderPlugin.prototype.saveHiddenState = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.saveData({ hiddenState: this.hiddenState })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    TaskHiderPlugin.prototype.loadHiddenState = function () {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.loadHiddenState()];
                    case 1:
                        _a.sent();
                        this.statusBar.setText(this.hiddenState ? 'Hiding Completed Tasks' : 'Showing Completed Tasks');
                        document.body.toggleClass('hide-completed-tasks', this.hiddenState);
                        obsidian.addIcon('tasks', taskShowIcon);
                        this.addRibbonIcon('tasks', 'Task Hider', function () {
