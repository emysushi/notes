...
var linkParse = async (link) => {
  ...
  try {
    const html = await (0, import_obsidian5.request)(link);
    if (html) {
...
var loadIcons = (icons) => {
  for (const key in icons) {
    (0, import_obsidian5.addIcon)(key, icons[key]);
  }
};

// main.ts
var TypingAsstPlugin = class extends import_obsidian6.Plugin {
  async loadSettings() {
